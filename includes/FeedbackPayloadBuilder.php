...
require_once dirname(__FILE__) . '/FeedbackDiagnosticsCollector.php';
require_once dirname(__FILE__) . '/FeedbackEnvironmentExtras.php';
require_once dirname(__FILE__) . '/FeedbackPayloadSchemaGuard.php';
require_once dirname(__FILE__) . '/FeedbackReportUuid.php';
require_once dirname(__FILE__) . '/FeedbackRuntimeEnvironment.php';
require_once dirname(__FILE__) . '/FeedbackWordPressInventory.php';
