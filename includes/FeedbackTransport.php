...
require_once dirname(__FILE__) . '/FeedbackTransportLog.php';
require_once dirname(__FILE__) . '/FeedbackHttpClient.php';
require_once dirname(__FILE__) . '/FeedbackEmailFallback.php';
require_once dirname(__FILE__) . '/FeedbackPayloadBuilder.php';
