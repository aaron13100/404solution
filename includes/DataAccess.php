...
require_once __DIR__ . '/ViewBuildCollaborationContext.php';
...
require_once __DIR__ . '/ViewBuildStageRuntimeState.php';
require_once __DIR__ . '/ViewBuildStageMarkers.php';
require_once __DIR__ . '/ViewBuildShutdownDiagnostics.php';
require_once __DIR__ . '/ViewBuildStageLogPresenter.php';
...
require_once __DIR__ . '/ViewBuildLockCoordinator.php';
...
require_once __DIR__ . '/ViewBuildFilesystemEnvironmentProbe.php';
require_once __DIR__ . '/ViewBuildSessionVariablesRepository.php';
require_once __DIR__ . '/ViewBuildSessionVariableWarningClassifier.php';
require_once __DIR__ . '/ViewBuildSessionVariablesProbe.php';
...
require_once __DIR__ . '/ViewQueryPolicy.php';
require_once __DIR__ . '/RedirectsForViewSqlBuilder.php';
require_once __DIR__ . '/ViewDoneQueryBuilder.php';
require_once __DIR__ . '/ViewDoneReader.php';
...
require_once __DIR__ . '/StatusCountsRepository.php';
require_once __DIR__ . '/RedirectsBulkReader.php';
require_once __DIR__ . '/LogsMetricsReader.php';
require_once __DIR__ . '/DatabaseMetadataReader.php';
require_once __DIR__ . '/HitsTableRebuildPolicy.php';
