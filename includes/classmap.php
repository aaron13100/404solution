...
$abj404ClassesByDirectory = array(
    ...
    'ajax' => array(
        ...
        'AjaxRequestContractValidator', 'AjaxFailureLogger', 'AjaxStageDiagnostics',
    ...
    'diagnostics' => array(
        ...
        'AjaxCheckpointLogger', 'CheckpointJournalWriter', 'AjaxRequestLedger',
        'AjaxQueryTimeline', 'AjaxRowLoopProgress', 'AjaxTraceJournal',
        'ShutdownEnvironmentInventory', 'ShutdownTeardownBracket', 'DiagnosticJournalExcerpt',
        'DiagnosticCollectionManifest', 'DiagnosticEvidencePriority', 'DiagnosticRequestGroup',
        'HostPressureSampler', 'RequestEnvironmentFingerprint', 'ClientBuildFingerprint',
    ...
    'feedback' => array(
        ...
        'SupportLogExcerpt', 'SupportEvidenceExcerpt', 'FeedbackDsrClient', 'FeedbackReportUuid',
