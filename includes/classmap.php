...
$abj404ClassesByDirectory = array(
    ...
    'ajax' => array(
        ...
        'AjaxRequestContractValidator', 'AjaxFailureLogger',
    ...
    'diagnostics' => array(
        ...
        'AjaxCheckpointLogger', 'AjaxFrequentCheckpointWriter',
        'CheckpointRecordFactory', 'CheckpointIntentStore',
        ...
        'AjaxRequestLedger',
        'AuthorizationLogTracer',
        'TableRenderTranslationTracer',
        ...
        'DiagnosticEvidencePriority', 'DetachAbEvidence', 'FailingSessionEvidence',
    ...
    'feedback' => array(
        ...
        'SupportLogExcerpt', 'SupportEvidenceExcerpt', 'FailingSessionSupportSection',
