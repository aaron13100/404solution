...
class ABJ_404_Solution_Ajax_RefreshAdminNonces {
    ...
    public function handle() {
        $ctx = ABJ_404_Solution_AjaxAdminEndpointSupport::startAjaxDebugContext(array(
        ...
        try {
            ...
            $nonces = array();
            foreach (ABJ_404_Solution_AjaxAdminEndpointSupport::adminNonceActions() as $action) {
