...
class ABJ_404_Solution_MaxMind_Decoder
{
    private $fileStream;
    private $pointerBase;
    ...
    public function decode($offset)
    {
        list(, $ctrlByte) = unpack(
            'C',
            ABJ_404_Solution_MaxMind_Util::read($this->fileStream, $offset, 1)
        );
        $offset++;
    ...
    private function decodeByType($type, $offset, $size)
    {
        ...
        $bytes = ABJ_404_Solution_MaxMind_Util::read($this->fileStream, $offset, $size);
        switch ($type) {
            case 'utf8_string':
    ...
    private function decodePointer($ctrlByte, $offset)
    {
        ...
        $buffer = ABJ_404_Solution_MaxMind_Util::read($this->fileStream, $offset, $pointerSize);
    ...
    private function sizeFromCtrlByte($ctrlByte, $offset)
    {
        ...
        $bytes = ABJ_404_Solution_MaxMind_Util::read($this->fileStream, $offset, $bytesToRead);
