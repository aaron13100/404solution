...
* Fixed canonical pagination handling terminating the request after WordPress rejected the redirect. A rejected redirect now keeps normal 404 handling active and records the destination, status and source in the debug log.
